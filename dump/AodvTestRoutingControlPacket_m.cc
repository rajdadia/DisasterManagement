...
int PacketRREQ::getpropDelay() const
{
    return propDelay;
}

void PacketRREQ::setpropDelay(int x)
{
    this->propDelay=x;
}
...
std::string PacketRREQDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 12: return int2string(pp->getpropDelay());//added by raj 19/10/18
        default: return "";
    }
}
...
bool PacketRREQDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 12: pp->setpropDelay(string2int(value)); return true;//added by raj on 19/10/18
