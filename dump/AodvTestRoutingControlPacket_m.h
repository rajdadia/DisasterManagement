...
class PacketRREQ : public ::RoutingPacket
{
  protected:
    ...
    double lifetime_var;
    int propDelay;//added a new parameter by Raj 19/10/18
  ...
  public:
    ...
    virtual int getpropDelay() const;//added by Raj 19/10/18
    virtual void setpropDelay(int x);// added by Raj 19/10/18
};
